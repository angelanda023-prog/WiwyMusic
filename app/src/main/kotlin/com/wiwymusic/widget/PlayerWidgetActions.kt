...
object PlayerWidgetActions {
    const val ACTION_PLAY_PAUSE = "com.wiwymusic.widget.action.PLAY_PAUSE"
    const val ACTION_NEXT = "com.wiwymusic.widget.action.NEXT"
    const val ACTION_PREVIOUS = "com.wiwymusic.widget.action.PREVIOUS"
    const val ACTION_REFRESH = "com.wiwymusic.widget.action.REFRESH"
