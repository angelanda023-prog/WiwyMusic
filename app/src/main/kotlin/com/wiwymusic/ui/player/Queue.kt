...
import com.wiwymusic.constants.QueueEditLockKey
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.wiwymusic.together.TogetherSessionState.Joined &&
                (togetherSessionState as com.wiwymusic.together.TogetherSessionState.Joined).role is com.wiwymusic.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.wiwymusic.together.TogetherSessionState.Joined
                                                                val isGuest =
                                                                    joined?.role is com.wiwymusic.together.TogetherRole.Guest
                                                                if (isGuest) {
