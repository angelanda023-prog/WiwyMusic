...
package com.wiwymusic.together
...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.wiwymusic.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.wiwymusic.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.wiwymusic.together.JoinDecision -> {
