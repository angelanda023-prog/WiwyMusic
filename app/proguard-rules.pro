...
-keep class com.wiwymusic.models.PersistQueue { *; }
-keep class com.wiwymusic.models.PersistPlayerState { *; }
-keep class com.wiwymusic.models.QueueData { *; }
-keep class com.wiwymusic.models.QueueType { *; }
-keep class com.wiwymusic.playback.queues.** { *; }
