...
Thank you for your interest in contributing to **WiwyMusic**! This document outlines the guidelines and best practices for contributing to the project. By following these recommendations, you help us maintain high-quality code and a collaborative, inclusive community.
...
We track bugs using [GitHub Issues](https://github.com/angelanda023-prog/WiwyMusic/issues). Before creating a new issue, please search existing issues to see if the problem has already been reported. If you find a similar issue, feel free to add relevant information or insights as a comment.
...
We also handle feature suggestions through [GitHub Issues](https://github.com/angelanda023-prog/WiwyMusic/issues). When suggesting a new feature:
...
Pull Requests (PRs) are the primary way to contribute code to WiwyMusic. To ensure your PR is effective and easy to review, follow these steps:
...
1. Open an issue in [GitHub Issues](https://github.com/angelanda023-prog/WiwyMusic/issues) proposing the language or translation improvement
2. Translate missing strings or improve existing translations in the relevant `values-XX/strings.xml` files
3. Open a Pull Request with your changes for review
...
Thank you for contributing to **WiwyMusic**! Your efforts help us build a better experience for all users.
